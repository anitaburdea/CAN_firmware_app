...
void PCANBasicClass::LoadAPI()
{
	...
	// Loads API functions
	//
    m_pInitialize = (fpInitialize)GetFunction((char *)"CAN_Initialize");
    m_pInitializeFD = (fpInitializeFD)GetFunction((char *)"CAN_InitializeFD");
    m_pUnInitialize = (fpUninitialize)GetFunction((char *)"CAN_Uninitialize");
    m_pReset = (fpReset)GetFunction((char *)"CAN_Reset");
    m_pGetStatus = (fpGetStatus)GetFunction((char *)"CAN_GetStatus");
    m_pRead = (fpRead)GetFunction((char *)"CAN_Read");
    m_pReadFD = (fpReadFD)GetFunction((char *)"CAN_ReadFD");
    m_pWrite = (fpWrite)GetFunction((char *)"CAN_Write");
    m_pWriteFD = (fpWriteFD)GetFunction((char *)"CAN_WriteFD");
    m_pFilterMessages = (fpFilterMessages)GetFunction((char *)"CAN_FilterMessages");
    m_pGetValue = (fpSetValue)GetFunction((char *)"CAN_GetValue");
    m_pSetValue = (fpGetValue)GetFunction((char *)"CAN_SetValue");
    m_pGetTextError = (fpGetErrorText)GetFunction((char *)"CAN_GetErrorText");
    m_pLookUpChannel = (fpLookUpChannel)GetFunction((char *)"CAN_LookUpChannel");
